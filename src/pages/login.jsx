  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-1/2 bg-blue-600 flex flex-col justify-center items-center text-white">
        ...
        <p className="mt-4 text-center px-8">Learn English easily and effectively, anytime and anywhere.</p>
      ...
      <div className="w-1/2 flex flex-col justify-center items-center">
        ...
        <p className="text-slate-600 mt-2 mb-8">Learn English Anytime, Anywhere.</p>
        ...
        <form className="w-2/3" onSubmit={handleLogin}>
          <div className="mb-4">
            ...
            <input type="text" placeholder="Your Username" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" id="username" name="username" required />
          </div>
          <div className="mb-4">
            <label className="block text-slate-700 text-sm font-bold mb-2" htmlFor="password">
              Password
            </label>
            <input type="password" placeholder="*********" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" id="password" name="password" required />
          </div>
