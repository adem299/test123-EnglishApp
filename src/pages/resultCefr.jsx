    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-3xl p-6">
        ...
        <div className="flex items-center justify-between gap-x-5">
          ...
          <div className="bg-gray-50 rounded-lg shadow-md p-6 w-2/3">
            <p className="text-gray-700 text-sm mb-2">
              Your vocabulary includes common words in everyday life. You also
              show an initial understanding of simple grammatical structures.
            </p>
        ...
        <div className="flex justify-end mt-6">
          ...
          onClick={() => window.location.href = 'https://test123-english-a7p9iddok-ade-mulyanas-projects.vercel.app/register/dashboard'}>
            Let’s Learn
          </button>
        </div>
      </div>
