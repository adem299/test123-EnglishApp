  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-6">Do you think this is a positive or negative development? Write at least 250 words.</p>
        <textarea
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div>
            <button className="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg mr-2 hover:bg-gray-400" onClick={() => setText('')}>
              Clear
            </button>
            <button className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600" onClick={handleAnalyze} disabled={loading}>
